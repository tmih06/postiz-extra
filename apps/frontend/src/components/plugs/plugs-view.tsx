...
const PLUGS: PlugItem[] = [
  {
    ...
    category: 'AI Video',
    description: 'Generate realistic talking avatar videos directly inside the Meltiply video studio.',
    status: 'connected',
  ...
  },
  {
    ...
    description: 'Allow Claude Code, Cursor, and custom coding agents to schedule and inspect Meltiply channels.',
    status: 'connected',
