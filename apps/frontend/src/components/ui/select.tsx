  ...
  return (
    <SelectPrimitive.Portal>
      ...
      >
        ...
        >
          <SlidingMenuHighlight containerRef={viewportRef} itemSelector="[data-dropdown-item]" />
          {children}
        </SelectPrimitive.Viewport>
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    data-dropdown-item
    className={cn(
      'relative z-10 flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm outline-none transition-colors focus:bg-transparent data-[highlighted]:bg-transparent hover:bg-transparent text-ink focus:text-ink data-[highlighted]:text-ink data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      className
    )}
    {...props}
  >
